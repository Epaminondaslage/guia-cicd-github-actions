...
- nunca usar `pull_request_target` combinado com checkout do código do fork sem sanitização, pois esse evento roda com o contexto (e secrets) do branch base, ampliando o risco;
