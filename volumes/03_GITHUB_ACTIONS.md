...
- nunca combine self-hosted com `pull_request_target` sem cuidado extremo, pois esse evento roda com o contexto (e secrets) do branch base mesmo para PRs de forks;
